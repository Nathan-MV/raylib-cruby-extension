...
RB_METHOD_ARG_STRING(rb_set_window_title, SetWindowTitle)
...
RB_METHOD_VEC2_WRAPPER_ARG_INT(rb_get_monitor_position, GetMonitorPosition)
...
RB_METHOD_VEC2_WRAPPER(rb_get_window_position, GetWindowPosition)
RB_METHOD_VEC2_WRAPPER(rb_get_scale_dpi, GetWindowScaleDPI)
RB_METHOD_STR_ARG_INT(rb_get_monitor_name, GetMonitorName)
RB_METHOD_ARG_STRING(rb_set_clipboard_text, SetClipboardText)
