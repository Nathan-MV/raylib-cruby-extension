...
RB_METHOD_CONST_STR_ARG_INT(rb_gamepad_name, GetGamepadName)
// RLAPI bool IsGamepadButtonPressed(int gamepad, int button);                        // Check if a gamepad button has been pressed once
RB_METHOD_BOOL_ARG_INT_INT(rb_gamepad_button_pressed, IsGamepadButtonPressed)
// RLAPI bool IsGamepadButtonDown(int gamepad, int button);                           // Check if a gamepad button is being pressed
RB_METHOD_BOOL_ARG_INT_INT(rb_gamepad_button_down, IsGamepadButtonDown)
// RLAPI bool IsGamepadButtonReleased(int gamepad, int button);                       // Check if a gamepad button has been released once
RB_METHOD_BOOL_ARG_INT_INT(rb_gamepad_button_released, IsGamepadButtonReleased)
// RLAPI bool IsGamepadButtonUp(int gamepad, int button);                             // Check if a gamepad button is NOT being pressed
RB_METHOD_BOOL_ARG_INT_INT(rb_gamepad_button_up, IsGamepadButtonUp)
...
RB_METHOD_FLOAT_ARG_INT_INT(rb_gamepad_axis_movement, GetGamepadAxisMovement)
// RLAPI int SetGamepadMappings(const char *mappings);                                // Set internal gamepad mappings (SDL_GameControllerDB)
RB_METHOD_INT_ARG_STR(rb_set_gamepad_mappings, SetGamepadMappings)
// RLAPI void SetGamepadVibration(int gamepad, float leftMotor, float rightMotor, float duration); // Set gamepad vibration for both motors (duration in seconds)
RB_METHOD_ARG_INT_FLOAT_FLOAT_FLOAT(rb_set_gamepad_vibration, SetGamepadVibration, self)
...
extern "C" void Init_Gamepad() {
  ...
  rb_define_module_function(rb_mGamepad, "vibration=", rb_set_gamepad_vibration, 4);
